...
class CafeMissionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(drawCafeNoKidsZoneMission), name: .drawCafeSeatMission, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(drawCafeOrderMilkShakeMission), name: .drawCafePoleMission, object: nil)
    }
